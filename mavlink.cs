...
{
    public const string MAVLINK_BUILD_DATE = "Wed Sep 01 2021";
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(19, "PARAM_ACK_TRANSACTION", 137, 24, 24, typeof( mavlink_param_ack_transaction_t )),
        ...
        new message_info(12902, "OPEN_DRONE_ID_AUTHENTICATION", 49, 53, 53, typeof( mavlink_open_drone_id_authentication_t )),
        new message_info(12903, "OPEN_DRONE_ID_SELF_ID", 249, 46, 46, typeof( mavlink_open_drone_id_self_id_t )),
        new message_info(12904, "OPEN_DRONE_ID_SYSTEM", 203, 46, 46, typeof( mavlink_open_drone_id_system_t )),
        new message_info(12905, "OPEN_DRONE_ID_OPERATOR_ID", 49, 43, 43, typeof( mavlink_open_drone_id_operator_id_t )),
        new message_info(12915, "OPEN_DRONE_ID_MESSAGE_PACK", 62, 254, 254, typeof( mavlink_open_drone_id_message_pack_t )),
    ...
    public struct mavlink_open_drone_id_location_t
    {
        ...
        public  float height;
            /// <summary>Seconds after the full hour with reference to UTC time. Typically the GPS outputs a time-of-week value in milliseconds. First convert that to UTC and then convert for this field using ((float) (time_week_ms % (60*60*1000))) / 1000.  [s] </summary>
        [Units("[s]")]
    ...
    /// extensions_start 0
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=53)]
    ///<summary> Data for filling the OpenDroneID Authentication message. The Authentication Message defines a field that can provide a means of authenticity for the identity of the UAS (Unmanned Aircraft System). The Authentication message can have two different formats. Five data pages are supported. For data page 0, the fields PageCount, Length and TimeStamp are present and AuthData is only 17 bytes. For data page 1 through 4, PageCount, Length and TimeStamp are not present and the size of AuthData is 23 bytes. </summary>
    public struct mavlink_open_drone_id_authentication_t
    {
        public mavlink_open_drone_id_authentication_t(uint timestamp,byte target_system,byte target_component,byte[] id_or_mac,/*MAV_ODID_AUTH_TYPE*/byte authentication_type,byte data_page,byte page_count,byte length,byte[] authentication_data) 
        {
              this.timestamp = timestamp;
              this.target_system = target_system;
              this.target_component = target_component;
        ...
        public  /*MAV_ODID_AUTH_TYPE*/byte authentication_type;
            /// <summary>Allowed range is 0 - 4.   </summary>
        [Units("")]
        [Description("Allowed range is 0 - 4.")]
        public  byte data_page;
            /// <summary>This field is only present for page 0. Allowed range is 0 - 5.   </summary>
        [Units("")]
        [Description("This field is only present for page 0. Allowed range is 0 - 5.")]
        public  byte page_count;
            /// <summary>This field is only present for page 0. Total bytes of authentication_data from all data pages. Allowed range is 0 - 109 (17 + 23*4).  [bytes] </summary>
        [Units("[bytes]")]
    ...
    {
        public mavlink_open_drone_id_system_t(int operator_latitude,int operator_longitude,float area_ceiling,float area_floor,ushort area_count,ushort area_radius,byte target_system,byte target_component,byte[] id_or_mac,/*MAV_ODID_OPERATOR_LOCATION_TYPE*/byte operator_location_type,/*MAV_ODID_CLASSIFICATION_TYPE*/byte classification_type,/*MAV_ODID_CATEGORY_EU*/byte category_eu,/*MAV_ODID_CLASS_EU*/byte class_eu) 
        {
    ...
    {
        public mavlink_open_drone_id_message_pack_t(byte target_system,byte target_component,byte single_message_size,byte msg_pack_size,byte[] messages) 
        {
              this.target_system = target_system;
              this.target_component = target_component;
        ...
        public  byte single_message_size;
            /// <summary>Number of encoded messages in the pack (not the number of bytes). Allowed range is 1 - 10.   </summary>
        [Units("")]
